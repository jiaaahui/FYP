...
export default function Report() {
    ...
    useEffect(() => {
        const loadData = async () => {
            setLoading(true);
            try {
                const [fetchedReports, fetchedEmployees] = await Promise.all([
                    getAllReports(),
                    getAllEmployees()
                ]);
                                    ...
                                    <tr key={report.ReportID} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                ...
                                                <span className="text-sm text-gray-900">{getEmployeeName(report.EmployeeID)}</span>
                                            </div>
                                        </td>
                        ...
                        <div className="mt-3">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-900">{getEmployeeName(selectedReport.EmployeeID)}</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center mt-1">
                                        ...
                                        <span className="ml-2 text-sm text-gray-900 capitalize">{selectedReport.Status}</span>
                                    </div>
                                </div>

                                <div>
                                    <label className="block text-sm font-medium text-gray-700">Date Reported</label>
                                    <p className="mt-1 text-sm text-gray-900">{formatDate(selectedReport.DateReported)}</p>
                                </div>
                            </div>
